...
func runOrchestrator(
	...
	runner, err := orchestrator.New(orchestrator.Config{
		...
		SlashCommands: orchestrator.SlashCommandOptions{
			CreateStory:        opts.createStorySlashCommand,
			DevStory:           opts.devStorySlashCommand,
			CodeReview:         opts.codeReviewSlashCommand,
			CreateStoryOptions: opts.createStorySlashOptions,
			DevStoryOptions:    opts.devStorySlashOptions,
			CodeReviewOptions:  opts.codeReviewSlashOptions,
		},
